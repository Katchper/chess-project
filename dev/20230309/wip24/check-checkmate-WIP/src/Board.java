public class Board {
    ...
    public void initialiseBoard(){
        ...
        gameBoard[3][0] = new Tile(2,3, new Queen(true));
        ...
        gameBoard[4][2] = new Tile(4,2, new Queen(true));
        gameBoard[1][3] = new Tile(1,3, new King(false));
        //gameBoard[2][3] = new Tile(2,3, new Rook(false));
        gameBoard[4][4] = new Tile(4,4, new Rook(true));
        gameBoard[5][3] = new Tile(5,3, new Rook(true));
